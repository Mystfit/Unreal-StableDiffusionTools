...
{
	return InPainter.PaintSectionBackground(InPainter.BlendColor(PromptSection->Prompt.Sentiment == EPromptSentiment::Positive ? FLinearColor(0.1, 0.6, 0.1) : FLinearColor(0.6, 0.1, 0.1)));
}
