...
def GetDependencies():
    ...
    return [
        ...
        MakeDependency({"name":"transformers", "url": "https://github.com/huggingface/transformers.git@829e8894183ad37c7bc8f85d9c420fda04d96d13"}),
        ...
        MakeDependency({"name":"diffusers", "version": "0.11.1"}),
